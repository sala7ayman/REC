...
<!-- Mirrored from bootstrapseven.com/demos/enhenyero/html/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Oct 2016 17:38:10 GMT -->
<head>
    <!-- Basic Page Needs
    ================================================== -->
    <meta charset="utf-8">
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="project-2col.html">Holiday Inn</a></li>
                        <li><a href="project-3col.html">American International School</a></li>
                        <li><a href="single-project.html">Dreams Beach</a></li>
                      </ul>
                    </li>
    ...
    <div id="en-content">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-4 col-md-4">
                    <div class="service"> <!-- Service #1 -->
                        <a href="service/industrial.html">
                            <img src="img/services/04.jpg" alt="" class="img-responsive">
                        </a>
                        <a href="service/industrial.html"><h4>Industrial Engineering</h4></a>
                        <p>Fusce laoreet ultricies sapien sed efficitur orci venenatis lotem ne ut Maecenas tortor magna quea velit inringilla sed. Praesent eget bibendum purus, quis placerat dui. Duis lacinia nisi sit ansequat lorem nunc, nec bibendum erat volutpat ultricies</p>
                        <a class="read-more" href="service/industrial.html">Read More <span class="fa fa-chevron-circle-right"></span></a>
                    </div>
                </div>
                ...
                <div class="col-sm-4 col-md-4">
                    <div class="service"> <!-- Service #2 -->
                        <a href="service/construction.html">
                            <img src="img/services/05.jpg" alt="" class="img-responsive">
                        </a>
                        <a href="service/construction.html"><h4>Building Constructions</h4></a>
                        <p>Nulla interdum dapibus erat nec elementum. Fusce aliquet tempor mi, vitae sollicitudin arcu convallis id. Vivamus aliquet rutrum dui a varius. Mauris ornare tortor in eleifend blanditullam ut ligula et neque.</p>
                        <a class="read-more" href="service/construction.html">Read More <span class="fa fa-chevron-circle-right"></span></a>
                    </div>
                </div>

                <div class="col-sm-4 col-md-4">
                    <div class="service"> <!-- Service #3 -->
                        <a href="service/communications.html">
                            <img src="img/services/06.jpg" alt="" class="img-responsive">
                        </a>
                        <a href="service/communications.html"><h4>Communications Enginerring</h4></a>
                        <p>Vivamus aliquet rutrum dui a varius. Mauris ornare tortor in eleifend blanditullam ut ligula et neque. Quisque porttitor sem libero auctor lorem fringilla sit amehasellus gravida nisi elitam egestda. Sedquis viverra enim. </p>
                        <a class="read-more" href="service/communications.html">Read More <span class="fa fa-chevron-circle-right"></span></a>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from bootstrapseven.com/demos/enhenyero/html/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Oct 2016 17:38:13 GMT -->
</html>