...
<!-- Mirrored from bootstrapseven.com/demos/enhenyero/html/single-project.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Oct 2016 17:39:00 GMT -->
<head>
    <!-- Basic Page Needs
    ================================================== -->
    <meta charset="utf-8">
    ...
    <title>Portfolio | 3 Col- Enhenyero Bootstrap Template</title>
  ...
  <body>
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown active">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li class="active"><a href="project-2col.html">Holiday Inn</a></li>
    ...
    <div id="en-header">
        <div class="container">
            <h2 class="pull-left">Holiday Inn</h2>
            <ol class="breadcrumb pull-right">
              <li><a href="index.html">Projects</a></li>
              <li class="active">Holiday Inn</li>
            </ol>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-md-4">
                    <div class="section-title text-left"> <!-- Left Section Title -->
                        <h2>Holiday Inn<br> <span style="font-size:15px;font-weight:normal">1<sup>st</sup> Settlement
 New Cairo
</span></h2>
                        <hr>
                    ...
                    <div id="imageSlider" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                              <img src="img/works/HI1.jpg"  style ="width:750px; height:450px"alt="...">
                            </div>
                            <div class="item">
                              <img src="img/works/HI2.jpg" style ="width:750px; height:450px" alt="...">
                            </div>
                            <div class="item">
                              <img src="img/works/HI3.jpg" style ="width:750px; height:450px" alt="...">
                            </div>
                        </div>
...
<!-- Mirrored from bootstrapseven.com/demos/enhenyero/html/single-project.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Oct 2016 17:39:14 GMT -->
</html>