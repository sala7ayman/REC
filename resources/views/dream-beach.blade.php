        ...
        <div class="container">
           <h2 class="pull-left">Projects</h2>
            <ol class="breadcrumb pull-right">
              ...
              <li class="active">Dreams Beach </li>
            </ol>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-md-4">
                    <div class="section-title text-left"> <!-- Left Section Title -->
                        <h2>Dreams Beach <br>Sharm El-Sheikh</h2>
                        <hr>
                    ...
                    <div id="imageSlider" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                              <img src="img/works/DP1.jpg" style="width:750px;height:480px" alt="...">
                            </div>
                            <div class="item">
                              <img src="img/works/DP2.jpg" style="width:750px;height:480px" alt="...">
                            </div>
                            <div class="item">
                              <img src="img/works/DP3.jpg" style="width:750px;height:480px" alt="...">
                            </div>
                        </div>
...
<!-- Mirrored from bootstrapseven.com/demos/enhenyero/html/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Oct 2016 17:39:17 GMT -->
</html>