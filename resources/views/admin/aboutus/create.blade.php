...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <!-- Main row -->
          <div class="row">
              <form action="/admin/aboutus/store" class="form-horizontal" id="postForm" enctype="multipart/form-data" method="post" accept-charset="utf-8" >
                  ...
                  <div class="box-header with-border">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                        <label  class="col-sm-2 control-label" for="title" required>Our History</label>
                        <div class="col-sm-10">
