      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class=""><a href="/admin/banner">Banner</a></li>
        ...
        <section class="content">
         ...
         {!! Form::model($banner, [
          ...
          <!-- Main row -->
          <div class="row">
              <form action="{{route('banners.store')}}" class="form-horizontal" id="postForm" enctype="multipart/form-data" method="post" accept-charset="utf-8" >
