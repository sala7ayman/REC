...
@section('content')
    ...
    <div id="en-header">
        <div class="container">
            <h2 class="pull-left">American International School</h2>
            <ol class="breadcrumb pull-right">
              <li><a href="index.html">Projects</a></li>
             <li class="active">American International School</li>
            </ol>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-md-4">
                    <div class="section-title text-left"> <!-- Left Section Title -->
                        <h2>American International School <br> <span style="font-size:15px;font-weight:normal">New Cairo</span></h2>
                        <hr>
                    ...
                    <div id="imageSlider" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                              <img src="img/works/AIS1.jpg"  style ="width:750px; height:450px"alt="...">
                            </div>
                            <div class="item">
                              <img src="img/works/AIS2.jpg" style ="width:750px; height:450px" alt="...">
                            </div>
                            <div class="item">
                              <img src="img/works/AIS3.jpg" style ="width:750px; height:450px" alt="...">
                            </div>
                        </div>
